  ...
  return (
    <section className="sectionGroup">
      ...
      <fieldset style={{ border: '1px solid var(--line)', borderRadius: '12px', padding: '16px', marginBottom: '20px' }}>
        <legend style={{ fontWeight: '800', color: 'var(--brand)', paddingLeft: '8px', paddingRight: '8px' }}>Como pretende chegar a Ribeirão Preto? <span style={{ color: 'var(--error)', fontWeight: 800 }}>*</span></legend>
      ...
      <fieldset style={{ border: '1px solid var(--line)', borderRadius: '12px', padding: '16px', marginBottom: '20px' }}>
        <legend style={{ fontWeight: '800', color: 'var(--brand)', paddingLeft: '8px', paddingRight: '8px' }}>Você precisará de transfer (aeroporto/hotel)? <span style={{ color: 'var(--error)', fontWeight: 800 }}>*</span></legend>
      ...
      {value.arrival === 'Avião' && (
        <div className="card" style={{ background: 'var(--bg)', border: '1px solid var(--line)', borderRadius: '12px', padding: '16px', marginBottom: '20px' }}>
          <label>
            <strong style={{ fontWeight: 600 }}>Aeroporto de chegada</strong>
          ...
          <div className="grid two">
            <label>
              <strong style={{ fontWeight: 600 }}>Número do voo</strong>
              <span style={{ color: 'var(--error)', marginLeft: 6, fontWeight: 800 }}>*</span>
              <input
            ...
            <label>
              <strong style={{ fontWeight: 600 }}>Horário de chegada</strong>
              <span style={{ color: 'var(--error)', marginLeft: 6, fontWeight: 800 }}>*</span>
              <input
                type="time"
