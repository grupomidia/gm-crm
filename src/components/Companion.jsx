  ...
  return (
    <section className="sectionGroup">
      ...
      <div className="radioGroup">
        <label><input type="radio" name="companion" value="no" checked={value.type === 'no'} onChange={() => onSetType('no')} />NÃO</label>
        <label><input type="radio" name="companion" value="couple" checked={value.type === 'couple'} onChange={() => onSetType('couple')} />SIM (casal)</label>
        <label><input type="radio" name="companion" value="twin" checked={value.type === 'twin'} onChange={() => onSetType('twin')} />SIM (camas de solteiro)</label>
      </div>
      ...
      {value.type !== 'no' && (
        <div className="companionDetails">
          ...
          <fieldset style={{ marginTop: '18px', padding: '14px', border: '1px solid var(--line)', borderRadius: '14px' }}>
            ...
            <div className="radioGroup">
              <label><input type="radio" name="companion_forum" value="yes" checked={value.participateForum === true} onChange={() => onChangeDetails('participateForum', true)} />SIM</label>
              <label><input type="radio" name="companion_forum" value="no" checked={value.participateForum === false} onChange={() => onChangeDetails('participateForum', false)} />NÃO</label>
            </div>
          </fieldset>
        </div>
      )}
